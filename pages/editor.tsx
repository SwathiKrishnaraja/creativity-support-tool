...
let text = "Please start writing your story below, and get feedback on how novel your ideas are, and how original your story work is. The tool does not provide feedback on your grammar or writing styles, rather it provides feedback on the creative quality of your ideas, and quantity of ideas. Please start writing your story below, and get feedback on how novel your ideas are, and how original your story work is. The tool does not provide feedback on your grammar or writing styles, rather it provides feedback on the creative quality of your ideas, and quantity of ideas. Please start writing your story below, and get feedback on how novel your ideas are.";
     ...
     <div className={styles.h6} >
      ...
      <Grid.Container gap={2} justify="center" height="100%">
        ...
        <Grid xs={24} md={12} className={styles.textEditor}>
          <div className={styles.editorLayout}>
            ...
            <div
              ...
              style={{width: "100%", height: "75%", border: "1px dotted black", borderRadius: '25px', padding: "10px"}}
              id="text-editor"
            />
            <Spacer w={2} />
            <Button type="secondary-light" className={styles.textEditorSubmit} onClick={() => submitTapped(setLoadingIndicatorOpen, state, setState)}>
              Get Feedback!
            </Button>
          </div>
        </Grid>
        ...
        <Grid xs={24} md={12} className={styles.resultPanel}>
          <div className={styles.editorLayout}>
            <div className={styles.resultContainer} style={{border: '1px dotted black', padding: '2%', backgroundColor: 'lightgrey', borderRadius: '25px'}}>
              ...
              <br />
              <Progress colors={colors} type="success" value={state.data.originality * 100} /> <br />
              Fluency <br />
              <Tooltip
                  style={{display: 'inline'}}
                  text={
                    'Some details on Fluency'
                  }
                  trigger="hover"
                  type="dark"
                  className={styles.tooltip}
              ...
              <br />
              <Progress colors={colors} type="success" value={state.data.fluency * 100} /> <br />
              Flexibility <br />
              <Tooltip
                  style={{display: 'inline'}}
                  text={
                    'Some details on Flexibility'
                  }
                  trigger="hover"
                  type="dark"
                  className={styles.tooltip}
              ...
              <br />
              <Progress colors={colors} type="success" value={state.data.flexibility * 100} />

              <Spacer w={10} />
              <div>
              <Text h1 className={styles.textEditorHeading2} style={{textAlign: 'center'}}>
                  Here are a few topics we identified from your essay. The size
                  of the bubble depicts the weight of these topics in your
                  essay.
                </Text>

                <div style={{overflowY: 'scroll', width: '650px', height: '100px', lineHeight: '300%', whiteSpace: 'nowrap'}}>
                  {/* placeholder to show the topic feedback as bubbles */}
                  {topicsData.map((topic, index) => {
                    return (
                      <><span
                        style={{backgroundColor: getTopicColorFromID(topic.id), padding: "10px", borderRadius: "999px", color: "white", fontWeight: 'bold'}}
                      >
                ...
                We identified the following strenghts in your creative writing style: <br />
                <ul>
                  {getStrengthsFromData(state.data).map((strength) => {
                    return (
                      <><span style={{textAlign: 'center'}}>{strength}</span><br /></>
                    );
                  })}
                </ul>
                </div> 
              ...
              <div>
                ...
                <br /><br />
                <div className={styles.bubblesFeedback} style={{backgroundColor: 'white'}}>
                  {topicsData.map((topic, index) => {
                    return (
                      <Bubble
                        size={(topic.count / totalCount) * 150}
                ...
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                  {/* <Link href="/inspiration"> */}
                    <Button type="secondary-light" className={styles.inspireMeButton} onClick={() => inspireMeTapped(state, setState)}>
                      {state.data.currentPage == "inspireMe" ? 'Return' : 'Inspire me!'}
                    </Button>
                  {/* </Link> */}
                </div>
              </div>
